/**
* @file
* @brief Implementation of the MCP2515 library
*/
...
/**
* @brief Chip select MCP2515 to be able to write over SPI
*
* @return void
*/
void mcp2515_select(){
...
/**
* @brief Deselect MCP2515 to be disable write over SPI
*
* @return void
*/
...
/**
* @brief Enable interrupts in MCP2515
*
* @return void
*/
...
/**
* @brief Interrupt service routine corresponding to interrupt generated by MCP2515
*
* @return void
*/
ISR(INT0_vect){
